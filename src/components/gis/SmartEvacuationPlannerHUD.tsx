...
export const SmartEvacuationPlannerHUD: React.FC<SmartEvacuationPlannerHUDProps> = ({
  ...
  return (
    <div
      ...
      className={`absolute inset-x-2 sm:inset-x-auto sm:start-4 bottom-2 sm:bottom-6 z-30 flex flex-col bg-slate-900/95 backdrop-blur-md border border-emerald-500/40 rounded-xl shadow-2xl transition-all duration-200 text-white ${
